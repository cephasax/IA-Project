package br.ufrn.ia.core.clustering;
...
//import weka.core.VlrDstPlaniMovie;
//import weka.core.VlrDstTSMRC01Movie;
//import weka.core.VlrDstTSMRC02Movie;
//import weka.core.VlrDstHieraMovie;
//import weka.core.VlrDstRCRaiMovie;
...
public class HierarchicalClustererIaProject extends AbstractClusterer implements OptionHandler, CapabilitiesHandler, Drawable {
	...
	public static final Tag[] TAGS_LINK_TYPE = { new Tag(SINGLE, "SINGLE"), new Tag(COMPLETE, "COMPLETE"),
			...
			new Tag(ADJCOMLPETE, "ADJCOMLPETE"), new Tag(NEIGHBOR_JOINING, "NEIGHBOR_JOINING") };

	public static void main(String[] argv) {
		runClusterer(new HierarchicalClustererIaProject(), argv);
	}

	Instances m_instances;
	
	// altera aqui a medida de distancia
	...
	public void setOptions(	boolean m_bPrintNewick,
			int m_nNumClusters,
		...
		this.m_bPrintNewick = m_bPrintNewick;							//default true
		this.m_nNumClusters = m_nNumClusters;							//default 2
		this.m_bDistanceIsBranchLength = m_bDistanceIsBranchLength; 	//default false
		this.m_bDebug = m_bDebug;										//default false
		this.m_DistanceFunction = m_DistanceFunction ;					//default EuclideanDistance;
		this.m_nLinkType = m_nLinkType;									//default AVERAGE
	}

	public HierarchicalClustererIaProject() {
		super();
	}
	...
	public void buildClusterer(Instances data) throws Exception {
		...
		// move all clusters in m_nClusterID array & collect hierarchy
		int iCurrent = 0;
	...
	public Enumeration listOptions() {
		...
		newVector.addElement(new Option(
				...
				1, "-L [SINGLE|COMPLETE|AVERAGE|MEAN|CENTROID|WARD|ADJCOMLPETE|NEIGHBOR_JOINING]"));
