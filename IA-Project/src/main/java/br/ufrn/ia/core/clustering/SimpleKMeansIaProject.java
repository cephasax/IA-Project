...
public class SimpleKMeansIaProject extends RandomizableClusterer
	...
	public void setOptions(	boolean m_displayStdDevs, 
							boolean m_dontReplaceMissing,
							int m_NumClusters,
							int m_MaxIterations,
							DistanceFunction m_DistanceFunction,
							boolean m_PreserveOrder,
							int m_Seed) throws Exception {

			this.m_displayStdDevs = m_displayStdDevs; 			//default false - missing values
			this.m_dontReplaceMissing = m_dontReplaceMissing; 	//default false
			this.m_NumClusters = m_NumClusters; 				//default 2
			this.m_MaxIterations = m_MaxIterations; 			//default 500
			this.m_DistanceFunction = m_DistanceFunction; 		//default Euclidian Distance
			this.m_PreserveOrder = m_PreserveOrder; 			//default false
			this.m_Seed = m_Seed; 								//default 1
	}
	
	//--- CEPHAS BARRETO --//
	
	public SimpleKMeansIaProject() {
		super();
