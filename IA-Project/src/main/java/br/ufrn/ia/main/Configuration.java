...
public class Configuration {
	...
	private final int m_NumClusters = 2;
	...
	private final int m_num_clusters = -1;
	...
	private final int m_nNumClusters = 2;
	...
	public Configuration() throws Exception{
		...
		em1 = new EMIaProject();
		em1.setOptions(	m_verbose, m_max_iterations, m_num_clusters, 
						m_minStdDev, m_displayModelInOldFormat, m_Seed_EM);
		
		hc1 = new HierarchicalClustererIaProject();
		hc1.setOptions(m_bPrintNewick, m_nNumClusters, m_bDistanceIsBranchLength, 
